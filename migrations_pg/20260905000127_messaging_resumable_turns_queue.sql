...
-- count (registre#126). BIGINT so it decodes as the i64 the row carries.
ALTER TABLE messaging_resumable_turns ADD COLUMN IF NOT EXISTS enqueue_seq BIGINT NOT NULL DEFAULT 0;
