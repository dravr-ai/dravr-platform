-- ABOUTME: Drops user_rate_limit_overrides.daily_limit; a per-user override sets the monthly request limit only (PostgreSQL version)
...
ALTER TABLE user_rate_limit_overrides DROP COLUMN IF EXISTS daily_limit;
