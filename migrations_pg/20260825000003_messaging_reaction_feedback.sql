-- ABOUTME: Links outbound messaging rows to the assistant chat message they delivered (PostgreSQL)
...
ALTER TABLE messaging_messages ADD COLUMN IF NOT EXISTS chat_message_id TEXT;
