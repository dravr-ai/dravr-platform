...
ALTER TABLE users ADD COLUMN billing_test BOOLEAN NOT NULL DEFAULT FALSE;
...
ALTER TABLE usage_counters ADD COLUMN coach_id UUID;
ALTER TABLE usage_counters ADD COLUMN group_id UUID;
