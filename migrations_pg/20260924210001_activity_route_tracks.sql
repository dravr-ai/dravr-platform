...
-- ABOUTME: Mirrors migrations/20260924210001_activity_route_tracks.sql with PG-native timestamps
--
...
-- the rest of that provider's data. Ids are TEXT, like cached_activities, so
-- the purge's statements bind the same way on both engines.
