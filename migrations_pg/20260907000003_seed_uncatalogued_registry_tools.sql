...
-- and is_enabled_by_default is TRUE, and min_plan is 'starter' — a higher plan
...
--
-- ON CONFLICT DO NOTHING: a database that has already booted holds a tc-auto
-- row under these tool_names and keeps it, along with any text an operator
-- changed.
