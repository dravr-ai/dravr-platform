...
-- the next id after tc-144, the highest any migration claims. ON CONFLICT on
-- tool_name: a database that already booted holds a synthesised `tc-auto-` row
-- under this name and keeps it, with any text an operator edited.
...
('tc-145', 'get_planned_workouts', 'Get Planned Workouts', 'Read the workouts a connected provider''s training calendar plans for the athlete', 'fitness', TRUE, NULL, 'starter')
