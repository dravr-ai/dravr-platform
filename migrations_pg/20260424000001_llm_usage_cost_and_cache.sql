...
ALTER TABLE llm_usage ADD COLUMN cost_usd DOUBLE PRECISION NOT NULL DEFAULT 0.0;
ALTER TABLE llm_usage ADD COLUMN cached_tokens BIGINT NOT NULL DEFAULT 0;
