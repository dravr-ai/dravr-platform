...
export const ui = {
  en: {
    ...
    'login.trust.encrypted': 'E2E Encrypted',
    'login.trust.terminal': 'No password needed',
    'login.trust.version': 'v0.4 — Boréal',
    'login.request': 'Request Access',
    'login.back': '← Back to Dravr',
    'login.footer.node': '46.3482° N, 72.5428° W — Rivière Saint-Maurice',
    'login.footer.rights': '© 2025 DRAVR. ALL RIGHTS RESERVED.',
  ...
  fr: {
    ...
    'login.trust.encrypted': 'Chiffré E2E',
    'login.trust.terminal': 'Sans mot de passe',
    'login.trust.version': 'v0.4 — Boréal',
    'login.request': 'Demander l\'accès',
    'login.back': '← Retour à Dravr',
    'login.footer.node': '46.3482° N, 72.5428° O — Rivière Saint-Maurice',
    'login.footer.rights': '© 2025 DRAVR. TOUS DROITS RÉSERVÉS.',
