...
// ABOUTME: The web app's writer from a chosen chrome language to users.locale
// ABOUTME: Registered once by main.tsx so every language change reaches the server
