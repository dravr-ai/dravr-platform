...
// ABOUTME: The two ways an installed agent is used from any chat, as the post-install hint teaches them
// ABOUTME: `/agent add @handle` binds it to the conversation; `@handle` in a message brings it in for one turn
...
/** The command that binds an installed agent to the open conversation. */
