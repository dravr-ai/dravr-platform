// ABOUTME: Admin System Agents management UI component
// ABOUTME: Provides CRUD operations for system agents and user assignments
//
...
export default function SystemCoachesTab() {
  ...
  const handleDelete = () => {
    if (selectedCoach && confirm(`Delete agent "${selectedCoach.title}"? This cannot be undone.`)) {
      ...
      <div className="space-y-6">
        ...
        {coachesLoading ? (
          ...
          <Card variant="dark" className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-on-surface mb-2">No system agents</h3>
            <p className="text-on-surface-variant mb-4">
              Create your first system agent to provide AI personas to your users.
            </p>
            <Button onClick={() => setIsCreating(true)}>Create Your First Agent</Button>
          </Card>
        ) : (
      ...
      <div className="space-y-6">
        ...
        <Card variant="dark">
          <h2 className="text-xl font-semibold text-on-surface mb-6">
            {isCreating ? 'Create System Agent' : `Edit "${selectedCoach?.title}"`}
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Textarea
              ...
              rows={2}
              placeholder="Brief description of the agent's specialty..."
            />
            ...
            <Textarea
              ...
              className="font-mono"
              rows={8}
              placeholder="You are Dravr, specializing in marathon training with expertise in..."
              required
    ...
    <div className="space-y-6">
      ...
      <Card variant="dark">
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            {selectedCoach.description && (
              <p className="text-on-surface-variant mt-2">{selectedCoach.description}</p>
            )}
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6 p-4 bg-surface-container-low rounded-lg border ghost-border">
          ...
          <div className="text-center">
            ...
            <div className="text-xs text-outline">Visibility</div>
          </div>
        </div>
        ...
        <div className="mb-6">
          ...
          <div className="p-4 bg-surface-container-low rounded-lg font-mono text-sm text-on-surface whitespace-pre-wrap max-h-48 overflow-y-auto border ghost-border scrollbar-dark">
        ...
        <div className="grid grid-cols-2 gap-4 text-sm text-outline pt-4 border-t ghost-border">
          ...
          <div>
            <span className="font-medium text-on-surface-variant">Last Updated:</span>{' '}
      ...
      <Card variant="dark">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-lg font-semibold text-on-surface">User Assignments</h3>
        ...
        {assignments.length === 0 ? (
          <p className="text-outline text-center py-8">
            No users assigned to this agent yet. Click "Assign Users" to add access.
          </p>
        ) : (
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div className="bg-surface-container-low rounded-xl max-w-lg w-full mx-4 max-h-[80vh] flex flex-col border ghost-border">
            <div className="p-6 border-b ghost-border">
              <h3 className="text-lg font-semibold text-on-surface">Assign Users to Agent</h3>
            ...
            <div className="flex-1 overflow-y-auto p-6 scrollbar-dark">
              {users.length === 0 ? (
                <p className="text-center text-outline">Loading users...</p>
              ) : (
                    ...
                    .map((user: User) => (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          {user.display_name && (
                            <div className="text-sm text-on-surface-variant">{user.display_name}</div>
                          )}
                        </div>
                        <span className={clsx(
            ...
            <div className="p-6 border-t ghost-border flex items-center justify-between">
