...
// ABOUTME: The agent's avatar beside a reply — the agent's initials on the primary tint, never the brand mark
...
interface CoachAvatarProps {
  /** The author label a reply carries — the agent's title, or the product name when no agent is attached. */
  label: string;
}
 ...
 * the product read as the author of every reply; the agent is the author.
 */
