...
describe('SettingsMenu', () => {
  it('lists every section with its name and hint, marks the open one, and signs out last', async () => {
    ...
    expect(within(nav).getByText('Strava, Garmin, TrainingPeaks, COROS and the data your agent reads')).toBeInTheDocument();
    ...
    expect(connections).toHaveAccessibleDescription('Strava, Garmin, TrainingPeaks, COROS and the data your agent reads');
