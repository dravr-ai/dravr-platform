...
export function InsightPreview({
  ...
  return (
    <div className={className}>
      ...
      <div
        className={`bg-surface-container-low rounded-lg p-4 text-on-surface text-sm ${maxHeight} overflow-y-auto prose prose-sm dark:prose-invert max-w-none prose-headings:text-on-surface prose-headings:font-semibold prose-headings:mt-4 prose-headings:mb-2 prose-strong:text-on-surface prose-ul:my-2 prose-li:my-0.5 prose-p:my-2`}
      >
        <Markdown
