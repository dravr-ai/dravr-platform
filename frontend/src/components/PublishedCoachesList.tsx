      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {coaches.map((coach) => (
          ...
          >
            ...
            <div className="flex items-start gap-3 mb-3">
              {coach.icon_url ? (
                <img
                  src={coach.icon_url}
                  alt={coach.title}
                  className="w-12 h-12 rounded-lg object-cover border ghost-border"
                />
              ) : (
                <div className="w-12 h-12 rounded-lg boreal-hero-gradient flex items-center justify-center flex-shrink-0">
            ...
            {/* Stats */}
            <div className="flex items-center gap-4 text-xs text-outline mb-4">
            ...
            {/* Actions */}
            <div className="flex items-center gap-2 pt-3 border-t ghost-border">
              <Button
                variant="secondary"
                size="sm"
