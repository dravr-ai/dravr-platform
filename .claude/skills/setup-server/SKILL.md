...
- An agent source at `../dravr-contremaitre/prompts/coaches`, or `PIERRE_AGENTS_DIR` set.
...
| `pierre-cli seed agents --agents-dir <dir>` | agent personas from contremaitre markdown |
