...
- **114 MCP Tools**: Activities, planned workouts, goals, analysis, sleep, recovery, nutrition, recipes, mobility
...
- [Tools Reference](tools-reference.md) - All 114 MCP tools
