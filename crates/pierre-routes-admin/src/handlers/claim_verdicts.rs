...
pub struct VerdictRow {
    ...
    pub category: String,
    /// Verdict status: `supported`, `unsupported`, `disputed`, `pending`.
    pub status: String,
    ...
    /// JSON-serialized references to evidence sources, when available.
...
pub(crate) async fn handle_list_claim_verdicts(
...
pub(crate) async fn handle_list_verdicts_by_conversation(
    State(context): State<Arc<AdminApiContext>>,
    Extension(admin_token): Extension<ValidatedAdminToken>,
