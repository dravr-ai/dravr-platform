...
//!
//! Wraps [`pierre_services::eval_harness::browse_fixtures`] and the
...
pub(crate) async fn handle_list_fixtures(
...
pub(crate) async fn handle_get_fixture(
    State(_context): State<Arc<AdminApiContext>>,
    Extension(admin_token): Extension<ValidatedAdminToken>,
...
pub(crate) async fn handle_put_fixture(
    State(_context): State<Arc<AdminApiContext>>,
    Extension(admin_token): Extension<ValidatedAdminToken>,
    AxumPath(name): AxumPath<String>,
...
pub(crate) async fn handle_delete_fixture(
    State(_context): State<Arc<AdminApiContext>>,
    Extension(admin_token): Extension<ValidatedAdminToken>,
    AxumPath(name): AxumPath<String>,
) -> AppResult<impl IntoResponse> {
