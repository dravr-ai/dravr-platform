...
impl AgentCard {
    ...
    fn create_tool_definitions() -> Vec<ToolDefinition> {
        vec![
            Self::tool_get_activities(),
            Self::tool_analyze_activity(),
            Self::tool_get_athlete(),
            Self::tool_set_goal(),
        ]
    }

    /// Tool definition: retrieve user fitness activities
    fn tool_get_activities() -> ToolDefinition {
        ToolDefinition {
    ...
    /// Tool definition: AI-powered activity analysis
    fn tool_analyze_activity() -> ToolDefinition {
        ToolDefinition {
    ...
    /// Tool definition: retrieve athlete profile
    fn tool_get_athlete() -> ToolDefinition {
        ToolDefinition {
    ...
    /// Tool definition: set fitness goal
    fn tool_set_goal() -> ToolDefinition {
        ToolDefinition {
            name: "set_goal".into(),
