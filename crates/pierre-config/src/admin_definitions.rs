// ABOUTME: Per-category parameter definition builders + ParameterDefinition struct
// ABOUTME: Pure-data catalog of admin-configurable parameters consumed by AdminConfigService
...
///
/// Holds the canonical parameter definitions loaded at startup by
/// `AdminConfigService`. Pure data — no service, database, or runtime
/// dependencies — so the catalog can live in the leaf config crate while
...
pub struct ParameterDefinition {
    ...
    /// Environment variable binding and its owning layer — see [`EnvBinding`].
...
fn add_definition<S: BuildHasher>(
...
pub fn register_llm_pricing<S: BuildHasher>(defs: &mut HashMap<String, ParameterDefinition, S>) {
...
pub fn register_feature_flags<S: BuildHasher>(defs: &mut HashMap<String, ParameterDefinition, S>) {
    // Feature Flags
    add_definition(
        defs,
        ParameterDefinition {
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: None,
            scientific_basis: None,
            env: boot_env("WEATHER_SERVICE_ENABLED"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
...
pub fn register_llm_provider_config<S: BuildHasher>(
    defs: &mut HashMap<String, ParameterDefinition, S>,
) {
    ...
    add_definition(defs,
        ParameterDefinition {
            ...
            units: None,
            scientific_basis: None,
            env: boot_env("PIERRE_LLM_PROVIDER"),
    ...
    add_definition(defs,
        ParameterDefinition {
            ...
            units: None,
            scientific_basis: None,
            env: boot_env("LOCAL_LLM_BASE_URL"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
...
pub fn register_heart_rate_zones<S: BuildHasher>(
    defs: &mut HashMap<String, ParameterDefinition, S>,
) {
    // Heart Rate Zones
    add_definition(
        ...
        ParameterDefinition {
            ...
            env: boot_env("FITNESS_ZONE_RECOVERY_MAX"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            env: boot_env("FITNESS_ZONE_ENDURANCE_MAX"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            env: boot_env("FITNESS_ZONE_TEMPO_MAX"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            env: boot_env("FITNESS_ZONE_THRESHOLD_MAX"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
...
pub fn register_algorithm_selection<S: BuildHasher>(
    defs: &mut HashMap<String, ParameterDefinition, S>,
) {
    // Algorithm Selection
    add_definition(
        ...
        ParameterDefinition {
            ...
            env: config_env("PIERRE_TSS_ALGORITHM"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            env: config_env("PIERRE_MAXHR_ALGORITHM"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
...
pub fn register_recommendation_engine<S: BuildHasher>(
    defs: &mut HashMap<String, ParameterDefinition, S>,
) {
...
pub fn register_sleep_recovery<S: BuildHasher>(defs: &mut HashMap<String, ParameterDefinition, S>) {
    // Sleep & Recovery
    add_definition(
        defs,
        ParameterDefinition {
...
pub fn register_tokio_runtime<S: BuildHasher>(defs: &mut HashMap<String, ParameterDefinition, S>) {
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: boot_env("TOKIO_WORKER_THREADS"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: boot_env("TOKIO_THREAD_STACK_SIZE"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: None,
            scientific_basis: None,
            env: boot_env("TOKIO_THREAD_NAME"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
...
pub fn register_sqlx_pool<S: BuildHasher>(defs: &mut HashMap<String, ParameterDefinition, S>) {
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: boot_env("SQLX_IDLE_TIMEOUT_SECS"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("seconds".to_owned()),
            scientific_basis: None,
            env: boot_env("SQLX_MAX_LIFETIME_SECS"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: None,
            scientific_basis: None,
            env: boot_env("SQLX_TEST_BEFORE_ACQUIRE"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: boot_env("SQLX_STATEMENT_CACHE_CAPACITY"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
...
pub fn register_cache_ttl<S: BuildHasher>(defs: &mut HashMap<String, ParameterDefinition, S>) {
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("seconds".to_owned()),
            scientific_basis: None,
            env: config_env("CACHE_PROFILE_TTL_SECS"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("seconds".to_owned()),
            scientific_basis: None,
            env: config_env("CACHE_ACTIVITY_LIST_TTL_SECS"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("seconds".to_owned()),
            scientific_basis: None,
            env: config_env("CACHE_ACTIVITY_TTL_SECS"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("seconds".to_owned()),
            scientific_basis: None,
            env: config_env("CACHE_STATS_TTL_SECS"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
...
pub fn register_strava_provider<S: BuildHasher>(
    defs: &mut HashMap<String, ParameterDefinition, S>,
) {
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            env: boot_env("STRAVA_RATE_LIMIT_15MIN"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("requests".to_owned()),
            scientific_basis: Some("Strava API documentation".to_owned()),
            env: boot_env("STRAVA_RATE_LIMIT_DAILY"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: boot_env("STRAVA_DEFAULT_ACTIVITIES_PER_PAGE"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("activities".to_owned()),
            scientific_basis: None,
            env: boot_env("STRAVA_MAX_ACTIVITIES_PER_REQUEST"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
...
pub fn register_garmin_provider<S: BuildHasher>(
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            env: config_env("GARMIN_RATE_LIMIT_HOURLY"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("requests".to_owned()),
            scientific_basis: Some("Garmin API documentation".to_owned()),
            env: config_env("GARMIN_RATE_LIMIT_DAILY"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("activities".to_owned()),
            scientific_basis: None,
            env: boot_env("GARMIN_DEFAULT_ACTIVITIES_PER_PAGE"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("activities".to_owned()),
            scientific_basis: None,
            env: boot_env("GARMIN_MAX_ACTIVITIES_PER_REQUEST"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("seconds".to_owned()),
            scientific_basis: None,
            env: config_env("GARMIN_RATE_LIMIT_BLOCK_SECS"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
...
pub fn register_mcp_network<S: BuildHasher>(defs: &mut HashMap<String, ParameterDefinition, S>) {
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("bytes".to_owned()),
            scientific_basis: None,
            env: boot_env("MCP_MAX_REQUEST_SIZE"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("bytes".to_owned()),
            scientific_basis: None,
            env: boot_env("MCP_MAX_RESPONSE_SIZE"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: boot_env("MCP_NOTIFICATION_CHANNEL_SIZE"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("seconds".to_owned()),
            scientific_basis: None,
            env: config_env("MCP_TCP_KEEP_ALIVE_SECS"),
            is_runtime_configurable: false,
            requires_restart: true,
        },
    );
...
pub fn register_monitoring<S: BuildHasher>(defs: &mut HashMap<String, ParameterDefinition, S>) {
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("MONITORING_MEMORY_WARN_MB"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("MB".to_owned()),
            scientific_basis: None,
            env: config_env("MONITORING_MEMORY_CRITICAL_MB"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("MONITORING_LATENCY_WARN_MS"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("ms".to_owned()),
            scientific_basis: None,
            env: config_env("MONITORING_LATENCY_CRITICAL_MS"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("%".to_owned()),
            scientific_basis: None,
            env: config_env("MONITORING_ERROR_RATE_WARN_PCT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("%".to_owned()),
            scientific_basis: None,
            env: config_env("MONITORING_ERROR_RATE_CRITICAL_PCT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("%".to_owned()),
            scientific_basis: None,
            env: config_env("MONITORING_POOL_USAGE_WARN_PCT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("%".to_owned()),
            scientific_basis: None,
            env: config_env("MONITORING_POOL_USAGE_CRITICAL_PCT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("%".to_owned()),
            scientific_basis: None,
            env: config_env("MONITORING_CACHE_HIT_RATE_WARN_PCT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("%".to_owned()),
            scientific_basis: None,
            env: config_env("MONITORING_CACHE_MISS_RATE_CRITICAL_PCT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
...
pub fn register_usage_quotas<S: BuildHasher>(defs: &mut HashMap<String, ParameterDefinition, S>) {
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("QUOTA_MAX_ACTIVE_CONVERSATIONS"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("QUOTA_DAILY_MESSAGE_CAP"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("QUOTA_WEEKLY_MESSAGE_CAP"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("QUOTA_DAILY_TOOL_CALL_LIMIT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("QUOTA_WEEKLY_TOOL_CALL_LIMIT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("QUOTA_DAILY_TOKEN_BUDGET"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("QUOTA_WEEKLY_TOKEN_BUDGET"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("QUOTA_BURST_MULTIPLIER"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("%".to_owned()),
            scientific_basis: None,
            env: config_env("QUOTA_WARNING_THRESHOLD_PERCENT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
...
pub fn register_activity_access_quotas<S: BuildHasher>(
    defs: &mut HashMap<String, ParameterDefinition, S>,
) {
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("QUOTA_DAILY_ACTIVITY_SUMMARY_LIMIT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("QUOTA_WEEKLY_ACTIVITY_SUMMARY_LIMIT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("requests/day".to_owned()),
            scientific_basis: None,
            env: config_env("QUOTA_DAILY_ACTIVITY_DETAILED_LIMIT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            units: Some("requests/week".to_owned()),
            scientific_basis: None,
            env: config_env("QUOTA_WEEKLY_ACTIVITY_DETAILED_LIMIT"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
    ...
    add_definition(
        ...
        ParameterDefinition {
            ...
            scientific_basis: None,
            env: config_env("QUOTA_COUNTER_RETENTION_DAYS"),
            is_runtime_configurable: true,
            requires_restart: false,
        },
    );
...
pub fn register_group_permissions<S: BuildHasher>(
    defs: &mut HashMap<String, ParameterDefinition, S>,
) {
    add_definition(
        defs,
