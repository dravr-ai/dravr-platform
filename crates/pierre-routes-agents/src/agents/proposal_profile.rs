// ABOUTME: Builds the onboarding agent proposal's sport-profile view and LLM prompt text
...
use pierre_services::agents::sport_code;
...
/// match an agent against. Capping here bounds what one long fact can spend of
...
/// Build a short agent-matching context line from the user's onboarding facts.
///
