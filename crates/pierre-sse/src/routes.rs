...
impl SseRoutes {
    ...
    pub fn routes(manager: Arc<SseManager>, ctx: Arc<dyn SseCtx>) -> Router {
        Router::new()
            .route(
    ...
    async fn handle_notification_sse(
        ...
        let overflow_strategy = ctx.sse_buffer_overflow_strategy();
                ...
                match receiver.recv().await {
                    ...
                    Err(broadcast::error::RecvError::Lagged(skipped)) => {
                        ...
                        match overflow_strategy {
                            SseBufferOverflowStrategy::DropOldest => {
                            ...
                            SseBufferOverflowStrategy::DropNew => {
                            ...
                            SseBufferOverflowStrategy::CloseConnection => {
                                info!(
