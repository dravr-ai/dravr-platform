// ABOUTME: Recipe data models for nutrition planning with training-aware meal timing
// ABOUTME: Defines Recipe, RecipeIngredient, MealTiming, MacroTargets, and related types
//
...
impl MacroTargets {
    ...
    /// Create targets from a calorie goal and macro distribution percentages
    ///
    /// The distribution percentages should sum to 100.
    /// Protein and carbs use 4 cal/g; fat uses 9 cal/g.
    #[must_use]
    pub fn from_calories_and_distribution(
        calories: f64,
        protein_pct: u8,
        carbs_pct: u8,
        fat_pct: u8,
