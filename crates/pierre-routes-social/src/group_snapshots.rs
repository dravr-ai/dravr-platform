...
//! Per-member fitness snapshot builder for the group analytics router.
//!
//! Fetches recent activities from each member's connected fitness
//! provider via [`pierre_tool_runtime::protocol::auth::AuthService`] and
//! computes training-load metrics (CTL/ATL/TSB) and weekly aggregates.
