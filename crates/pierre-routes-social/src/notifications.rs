...
impl NotificationRoutes {
    ...
    pub fn routes<C: SocialCtx + MiddlewareCtx>(resources: Arc<C>) -> Router {
        Router::new()
            ...
            .route(
                ...
                post(Self::handle_register_device::<C>).get(Self::handle_list_devices::<C>),
            )
            .route(
                "/api/notifications/device/{id}",
                delete(Self::handle_deactivate_device::<C>),
            )
            // Preferences management
            .route(
                "/api/notifications/preferences",
                get(Self::handle_get_preferences::<C>).put(Self::handle_update_preferences::<C>),
            )
            // Notification feed
            .route(
                "/api/notifications",
                get(Self::handle_list_notifications::<C>),
            )
            .route(
                "/api/notifications/unread-count",
                get(Self::handle_unread_count::<C>),
            )
            .route(
                "/api/notifications/{id}/read",
                post(Self::handle_mark_read::<C>),
            )
            .route(
                "/api/notifications/{id}/opened",
                post(Self::handle_mark_opened::<C>),
            )
            .route(
                "/api/notifications/{id}/dismissed",
                post(Self::handle_mark_dismissed::<C>),
            )
            .route(
                "/api/notifications/read-all",
                post(Self::handle_mark_all_read::<C>),
            )
            .route(
                "/api/notifications/{id}",
                delete(Self::handle_delete_notification::<C>),
            )
            // Analytics
            .route(
                "/api/notifications/analytics",
                get(Self::handle_get_analytics::<C>),
            )
            // Badge sync
            .route(
                "/api/notifications/badge-sync",
                post(Self::handle_badge_sync::<C>),
            )
            // Scheduled notifications
            .route(
                "/api/notifications/scheduled",
                get(Self::handle_list_scheduled::<C>).post(Self::handle_create_scheduled::<C>),
            )
            .route(
                "/api/notifications/scheduled/{id}",
                put(Self::handle_update_scheduled::<C>).delete(Self::handle_delete_scheduled::<C>),
            )
    ...
    fn get_service<C: SocialCtx>(resources: &Arc<C>) -> Result<&NotificationService, AppError> {
        resources
    ...
    async fn handle_register_device<C: SocialCtx + MiddlewareCtx>(
    ...
    async fn handle_list_devices<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
    ...
    async fn handle_deactivate_device<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_get_preferences<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
    ...
    async fn handle_update_preferences<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ...
    async fn handle_list_notifications<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ...
    async fn handle_unread_count<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
    ...
    async fn handle_mark_read<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_mark_all_read<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
    ...
    async fn handle_delete_notification<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_mark_opened<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_mark_dismissed<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_get_analytics<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ...
    async fn handle_list_scheduled<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
    ...
    async fn handle_create_scheduled<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ...
    async fn handle_update_scheduled<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ...
    async fn handle_delete_scheduled<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_badge_sync<C: SocialCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
