// ABOUTME: PostgreSQL-backed TrainingPlanRepository, emitted from the shared implementation in repositories/training_plans.rs
...
impl_training_plan_repository!(PostgresDatabase, sqlx::Postgres);
