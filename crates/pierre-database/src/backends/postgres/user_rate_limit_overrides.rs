// ABOUTME: PostgreSQL-backed UserRateLimitOverrideRepository, emitted from the shared body in repositories/user_rate_limit_overrides.rs
...
impl_user_rate_limit_override_repository!(PostgresDatabase, NativeUuid);
