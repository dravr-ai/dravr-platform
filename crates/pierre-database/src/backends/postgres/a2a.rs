// ABOUTME: PostgreSQL-backed A2ARepository, emitted from the shared implementation in repositories/a2a.rs
// ABOUTME: Ids are native uuid, lists are TEXT[], IPs are INET, and a usage row takes its SERIAL default here
//
...
impl_a2a_repository!(
    ...
    NativeUuid,
    NativeList,
    day = "CAST(timestamp AT TIME ZONE 'UTC' AS DATE)",
    usage_id = "DEFAULT",
    inet = "::inet"
);
