// ABOUTME: PostgreSQL-backed AgentArtefactRepository — an agent package's flavour, skeleton and workout files
...
#[async_trait]
impl AgentArtefactRepository for PostgresDatabase {
...
fn row_to_artefact(row: &PgRow) -> AppResult<AgentArtefact> {
