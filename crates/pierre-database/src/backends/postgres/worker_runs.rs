// ABOUTME: PostgreSQL-backed WorkerRunRepository, emitted from the shared implementation in repositories/worker_runs.rs
...
impl_worker_run_repository!(PostgresDatabase);
