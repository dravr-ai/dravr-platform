// ABOUTME: PostgreSQL-backed DelegatedConnectionRepository, emitted from the shared implementation in repositories/delegated_connections.rs
...
impl_delegated_connection_repository!(PostgresDatabase, PgRow, NativeUuid);
