// ABOUTME: PostgreSQL-backed ShortLinkRepository, emitted from the shared implementation in repositories/short_links.rs
...
impl_short_link_repository!(PostgresDatabase);
