// ABOUTME: PostgreSQL-backed HarnessMemoryRepository, emitted from the shared implementation in repositories/memory.rs
// ABOUTME: Compaction blocks, user facts, agent notes, followups and sessions; timestamps are native timestamptz here
//
...
impl_harness_memory_repository!(PostgresDatabase);
