// ABOUTME: PostgreSQL implementation of the McpTaskRepository trait
// ABOUTME: Mirrors the SQLite path for MCP Tasks extension handle persistence
//
...
fn row_to_task(row: &PgRow) -> McpTaskRow {
    McpTaskRow {
...
#[async_trait]
impl McpTaskRepository for PostgresDatabase {
