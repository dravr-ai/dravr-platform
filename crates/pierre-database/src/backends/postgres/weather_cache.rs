// ABOUTME: PostgreSQL-backed WeatherCacheRepository for dravr-meteo persistent cache
// ABOUTME: Mirrors the SQLite impl with PG-native types (BIGINT, TIMESTAMPTZ, ON CONFLICT DO UPDATE)
//
...
#[async_trait]
impl WeatherCacheRepository for PostgresDatabase {
    async fn get(
        &self,
        lat_centi: i32,
        lng_centi: i32,
