...
///
/// Returns an error if the user is not found or the database update fails.
pub async fn update_locale(pool: &Pool<Sqlite>, user_id: Uuid, locale: &str) -> AppResult<()> {
...
///
/// Returns an error if the user is not found or the database update fails.
pub async fn set_timezone(pool: &Pool<Sqlite>, user_id: Uuid, timezone: &str) -> AppResult<()> {
...
///
/// Returns an error if the user is not found or the database update fails.
pub async fn set_theme(pool: &Pool<Sqlite>, user_id: Uuid, theme: Option<&str>) -> AppResult<()> {
