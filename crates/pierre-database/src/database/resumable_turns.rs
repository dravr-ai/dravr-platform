// ABOUTME: SQLite implementation of the ResumableTurnRepository trait
// ABOUTME: Records messaging turns and leases them, in conversation order, in single UPDATE … RETURNING statements
//
...
fn row_to_turn(row: &SqliteRow) -> ResumableTurnRow {
    ResumableTurnRow {
        id: row.get("id"),
...
#[async_trait]
impl ResumableTurnRepository for Database {
