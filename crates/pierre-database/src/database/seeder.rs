// ABOUTME: SQLite-backed SeederRepository, emitted from the shared implementation in repositories/seeder.rs
// ABOUTME: uuids are TEXT here, the usage tables key on the seed's uuid, and a2a_clients.capabilities is JSON text
//
...
use crate::repositories::seeder_body::{
    ...
    text_and_hash, uuid_text_column, TextSeedColumns,
};
...
impl_seeder_repository!(Database, TextUuid, TextSeedColumns, ", id", ", $6");
