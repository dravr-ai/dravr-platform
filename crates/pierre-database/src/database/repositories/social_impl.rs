// ABOUTME: Direct SocialRepository impl on Database (SQLite social graph + insights)
// ABOUTME: Split out of repositories/direct_impls.rs to mirror per-domain PG backend shape
//
// SPDX-License-Identifier: MIT OR Apache-2.0
// Copyright (c) 2026 dravr.ai

//! #[async_trait] impl SocialRepository for Database — friend connections, shared insights, reactions, adapted insights.
...
use pierre_core::models::TrainingPhase;
