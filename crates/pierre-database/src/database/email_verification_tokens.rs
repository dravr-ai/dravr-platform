// ABOUTME: SQLite-backed EmailVerificationRepository, emitted from the shared implementation in repositories/email_verification_tokens.rs
...
impl_email_verification_repository!(Database, TextUuid);
