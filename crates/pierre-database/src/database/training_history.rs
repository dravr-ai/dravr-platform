// ABOUTME: SQLite-backed TrainingHistoryRepository, emitted from the shared implementation in repositories/training_history.rs
...
impl_training_history_repository!(Database, TextUuid::bind);
