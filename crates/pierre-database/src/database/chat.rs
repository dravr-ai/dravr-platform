// ABOUTME: SQLite-backed ChatRepository, emitted from the shared implementation in repositories/chat.rs
// ABOUTME: Every id and timestamp column is TEXT here: ids bind and read as the text the caller holds
//
...
use crate::repositories::chat::{
    ...
    GET_MESSAGES_SQL, GET_PARTICIPANT_SQL, GET_RECENT_MESSAGES_SQL, LIST_CONVERSATIONS_SQL,
    LIST_ONBOARDING_STATES_SQL, LIST_PARTICIPANTS_SQL, MESSAGE_COUNT_SQL, READ_TARGET_SQL,
    RECENT_CONVERSATIONS_ADMIN_SQL, REMOVE_PARTICIPANT_SQL, SET_AGENT_ID_SQL, SET_CHANNEL_SQL,
    SET_GROUP_ID_SQL, SET_ONBOARDING_STATE_SQL, SET_SESSION_ID_SQL, TOUCH_CONVERSATION_SQL,
    UPDATE_TITLE_SQL, UPSERT_FEEDBACK_SQL,
};
use crate::repositories::chat_backend::impl_chat_repository;
use crate::repositories::uuid_columns::TextUuid;

impl_chat_repository!(Database, SqliteRow, TextUuid);
