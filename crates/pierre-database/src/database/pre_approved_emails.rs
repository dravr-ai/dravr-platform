// ABOUTME: SQLite-backed PreApprovedEmailRepository, emitted from the shared implementation in repositories/pre_approved_emails.rs
// ABOUTME: allowed_by is a TEXT column here, so the uuid binds as hyphenated text and reads back with no cast
...
impl_pre_approved_email_repository!(Database, TextUuid::bind, "");
