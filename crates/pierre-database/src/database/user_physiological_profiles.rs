// ABOUTME: SQLite-backed UserPhysiologicalProfileRepository + DossierRepository, emitted from repositories/user_physiological_profiles.rs
// ABOUTME: Ids bind as hyphenated text and the zone-set JSON as TEXT, through the same binds Postgres uses
//
...
impl_user_physiological_profile_repository!(Database);
