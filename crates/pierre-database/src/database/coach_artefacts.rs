// ABOUTME: SQLite-backed CoachArtefactRepository — a coach package's flavour, skeleton and workout files
// ABOUTME: Replace-the-set write in one transaction; read ordered by (kind, slug); mirrors backends/postgres/coach_artefacts.rs
//
...
#[async_trait]
impl CoachArtefactRepository for Database {
...
fn row_to_artefact(row: &SqliteRow) -> AppResult<CoachArtefact> {
