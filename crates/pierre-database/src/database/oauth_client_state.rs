// ABOUTME: SQLite-backed OAuthClientStateRepository, emitted from the shared implementation in repositories/oauth_client_state.rs
...
impl_oauth_client_state_repository!(Database);
