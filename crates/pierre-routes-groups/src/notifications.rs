...
// ABOUTME: Generic over GroupsCtx + MiddlewareCtx; mounted by the composition root
//
...
impl NotificationRoutes {
    ...
    async fn handle_list_devices<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
    ...
    async fn handle_deactivate_device<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_get_preferences<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
    ...
    async fn handle_update_preferences<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ...
    async fn handle_list_notifications<C: GroupsCtx + MiddlewareCtx>(
        ...
        if let Some(ref cat) = query.category {
            if NotificationCategory::from_str_opt(cat).is_none() {
                let valid = NotificationCategory::all()
                    .iter()
                    .map(NotificationCategory::as_str)
                    .collect::<Vec<_>>()
                    .join(", ");
                return Err(AppError::invalid_input(format!(
                    "Invalid category: {cat}. Valid categories: {valid}"
                )));
            }
        }
    ...
    async fn handle_unread_count<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
    ...
    async fn handle_mark_read<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_mark_all_read<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
    ...
    async fn handle_delete_notification<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_mark_opened<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_mark_dismissed<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_get_analytics<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ...
    async fn handle_list_scheduled<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
    ...
    async fn handle_create_scheduled<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ...
    async fn handle_update_scheduled<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ...
    async fn handle_delete_scheduled<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
        Path(id): Path<Uuid>,
    ) -> Result<Response, AppError> {
    ...
    async fn handle_badge_sync<C: GroupsCtx + MiddlewareCtx>(
        State(resources): State<Arc<C>>,
        auth: AuthenticatedUser,
    ) -> Result<Response, AppError> {
        let auth = auth.into_inner();
