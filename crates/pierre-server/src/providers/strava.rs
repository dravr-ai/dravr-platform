...
use pierre_auth::oauth2_client::client::PkceParams;
...
impl StravaProvider {
    ...
    pub async fn exchange_code(&mut self, code: &str) -> AppResult<(String, String)> {
        ...
        let (token, athlete) = pierre_auth::oauth2_client::strava::exchange_strava_code(
            &self.client,
    ...
    pub async fn exchange_code_with_pkce(
        ...
        let (token, athlete) = pierre_auth::oauth2_client::strava::exchange_strava_code_with_pkce(
            &self.client,
            &self.config.client_id,
            &self.config.client_secret,
            code,
    ...
    pub async fn refresh_access_token(&mut self) -> AppResult<(String, String)> {
        ...
        let new_token = pierre_auth::oauth2_client::strava::refresh_strava_token(
            &self.client,
            &self.config.client_id,
            &self.config.client_secret,
            refresh_token,
