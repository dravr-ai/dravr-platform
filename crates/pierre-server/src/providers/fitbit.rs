...
impl FitbitProvider {
    ...
    pub async fn exchange_code(
        ...
        let (token, _) = pierre_auth::oauth2_client::fitbit::exchange_fitbit_code(
            &self.client,
            client_id,
            client_secret,
            code,
    ...
    pub async fn exchange_code_with_pkce(
        ...
        let (token, _) = pierre_auth::oauth2_client::fitbit::exchange_fitbit_code_with_pkce(
            &self.client,
            client_id,
            client_secret,
            code,
    ...
    pub async fn refresh_access_token(&mut self) -> AppResult<(String, String)> {
        ...
        let new_token = pierre_auth::oauth2_client::fitbit::refresh_fitbit_token(
            &self.client,
            client_id,
            client_secret,
            refresh_token,
