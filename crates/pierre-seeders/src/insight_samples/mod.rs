// ABOUTME: Insight sample seeder — loads insight samples from markdown and validates against the LLM
// ABOUTME: Parser submodule converts markdown+YAML frontmatter into structured InsightSampleDefinition
//
...
//!
//! This module loads insight sample definitions from markdown files and optionally
