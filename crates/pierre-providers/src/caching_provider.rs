...
//!
//! ```ignore
//! use pierre_providers::caching_provider::{CachingFitnessProvider, CachePolicy};
//! use pierre_providers::create_provider;
//! use pierre_providers::core::FitnessProvider;
//! use pierre_cache::{CacheConfig, CacheProvider};
