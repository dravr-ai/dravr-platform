...
async fn require_roster_manager<C: CoachesCtx + MiddlewareCtx>(
    headers: &HeaderMap,
    ctx: &Arc<C>,
...
/// athletes yet.
async fn list_athletes<C: CoachesCtx + MiddlewareCtx>(
...
async fn assign_athlete<C: CoachesCtx + MiddlewareCtx>(
    State(ctx): State<Arc<C>>,
    headers: HeaderMap,
...
async fn revoke_assignment<C: CoachesCtx + MiddlewareCtx>(
    State(ctx): State<Arc<C>>,
    headers: HeaderMap,
