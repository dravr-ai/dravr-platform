...
ALTER TABLE coaching_groups ADD COLUMN digest_mode TEXT NOT NULL DEFAULT 'off'; -- idempotency-ok: SQLite ADD COLUMN has no IF NOT EXISTS; _sqlx_migrations prevents re-run
