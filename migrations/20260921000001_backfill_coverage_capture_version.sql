...
ALTER TABLE activity_backfill_coverage ADD COLUMN capture_version INTEGER NOT NULL DEFAULT 0; -- idempotency-ok: SQLite ADD COLUMN has no IF NOT EXISTS; _sqlx_migrations prevents re-run
