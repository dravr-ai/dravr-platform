...
-- deeper backfill fetched. `hit_feed_end` is 1 when that scrape exhausted the
...
CREATE TABLE IF NOT EXISTS activity_backfill_coverage (
    ...
    hit_feed_end       INTEGER NOT NULL DEFAULT 0,  -- 1 when the provider feed ended (no older data)
