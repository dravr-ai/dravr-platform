...
('tc-140', 'estimate_vo2max', 'Estimate VO2max', 'Estimate VO2max from a field test the athlete describes', 'configuration', 1, NULL, 'starter'),
('tc-141', 'estimate_lactate_thresholds', 'Estimate Lactate Thresholds', 'Locate LT1 and LT2 from a step test the athlete reports', 'configuration', 1, NULL, 'starter'),
('tc-142', 'recommend_plan_flavour', 'Recommend Plan Flavour', 'Rank the training flavours an athlete can run and lay out the season', 'configuration', 1, NULL, 'starter'),
('tc-143', 'forget_playbook', 'Forget Playbook', 'Delete one learned coaching playbook by id (GDPR forget)', 'fitness', 1, NULL, 'starter'),
('tc-144', 'verify_claim', 'Verify Claim', 'Check a factual claim against the claim-verification pipeline', 'fitness', 1, NULL, 'starter');
