-- ABOUTME: Drops oauth_client_states.bridge_callback_token; Dravr no longer posts a completed flow to a local bridge listener
...
ALTER TABLE oauth_client_states DROP COLUMN bridge_callback_token;  -- idempotency-ok: _sqlx_migrations prevents re-run; SQLite DROP COLUMN has no IF EXISTS
