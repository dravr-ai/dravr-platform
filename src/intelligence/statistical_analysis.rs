...
impl StatisticalAnalyzer {
    ...
    pub fn apply_exponential_smoothing(data_points: &mut [TrendDataPoint], alpha: f64) {
        ...
        for i in 1..data_points.len() {
            ...
            let smoothed = alpha * data_points[i].value + (1.0 - alpha) * previous_smoothed;
    ...
    fn standard_normal_cdf(x: f64) -> f64 {
        ...
        let cdf = 1.0 - 0.398_942_3 * (-0.5 * x * x).exp() * poly;
    ...
    pub fn calculate_confidence_interval(
        ...
        let predicted_y = regression.slope * x_value + regression.intercept;
