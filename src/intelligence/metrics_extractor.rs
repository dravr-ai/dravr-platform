...
impl MetricType {
    ...
    #[allow(clippy::cast_precision_loss)] // Safe: Duration seconds fit in f64 mantissa for fitness data
    pub fn extract_value(self, activity: &Activity) -> Option<f64> {
        match self {
            ...
            Self::Duration => Some(activity.duration_seconds as f64),
...
impl SafeMetricExtractor {
    ...
    #[allow(clippy::cast_precision_loss)] // Safe: Activity counts fit in f64 mantissa for fitness data
