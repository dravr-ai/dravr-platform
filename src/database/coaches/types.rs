// ABOUTME: Type definitions for coach database operations (structs, enums, request/response types)
// ABOUTME: Shared across all coach sub-modules for CRUD, assignments, versioning, and store features
//
