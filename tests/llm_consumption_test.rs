...
use pierre_mcp_server::database::llm_usage::InsertLlmUsage;
use pierre_mcp_server::database::repositories::LlmUsageRepository;
use pierre_mcp_server::database::test_utils::create_test_db;
...
async fn test_group_by_provider() {
    use pierre_mcp_server::database::llm_usage::LlmUsageGroupBy;
