...
// ABOUTME: The label between two days of a thread — today, yesterday, or the date spelled out
...
export default function DaySeparator({ label }: { label: string }) {
  return (
    <View className="my-3 flex-row justify-center" testID="day-separator">
      <Text accessibilityRole="header" className="text-sm font-medium text-on-surface-variant">
        {label}
      </Text>
    </View>
  );
