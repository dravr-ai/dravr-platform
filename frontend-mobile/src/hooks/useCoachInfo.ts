...
// ABOUTME: The same list the @handle palette reads, so Coach info can never name a coach a mention cannot reach
...
/** What Coach info needs about the coach a thread is bound to. */
 ...
 * so opening Coach info costs no extra request in a session that has typed a
