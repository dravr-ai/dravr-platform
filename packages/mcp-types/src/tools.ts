...
export interface GetActivitiesParams {
  ...
  /** Maximum number of activities to return (1-400). Use the smallest value that answers the question: 1 for 'last activity', 5-10 for 'this week', 20 for broader queries. Response includes has_more and pagination info for follow-up requests. */
  limit?: number;
